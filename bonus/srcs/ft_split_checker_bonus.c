...
static char	*ft_splitdup(const char *s, size_t start, size_t finish, t_checker *checker)
{
	char	*dest;
	size_t	i;
...
static char	**ft_process_string(char **dest, const char *str, char c, t_checker *checker)
{
	size_t	i;
	size_t	p1;
	size_t	start;
