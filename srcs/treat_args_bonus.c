...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/05 10:10:04 by sperez-p          #+#    #+#             */
/*   Updated: 2022/10/05 10:11:16 by sperez-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_treat_args(int argc, char **argv, t_checker *checker)
{
	...
	while (*(checker->args + ++i))
		ft_insert_end_checker(ft_atoi_checker(*(checker->args + i), checker),
			&checker->stack_a, checker);
